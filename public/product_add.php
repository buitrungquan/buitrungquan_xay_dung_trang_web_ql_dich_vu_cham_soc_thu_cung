...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    // Chỉ tạo sản phẩm nếu không có lỗi upload
    if(!$uploadError){
        $data = [
            'name' => $_POST['name'],
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-plus-circle"></i> Thêm Sản phẩm</h2>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="file" name="image" id="image" class="form-control" accept="image/jpeg,image/jpg,image/png,image/gif,image/webp" required>
